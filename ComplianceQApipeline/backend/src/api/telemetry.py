...
logger = logging.getLogger("Advert-Analysis-telemetry")
# Example log output: "Advert-Analysis-telemetry - INFO - Azure Monitor enabled"
...
def setup_telemetry():
    ...
    try:
        ...
        configure_azure_monitor(
            ...
            logger_name="advert-analysis-tracer"   # Optional: custom tracer name
        )
        # 
